...
public class RichTextActivity extends Activity implements OnClickListener {
    ...
    private void initRichEdit() {
        ...
        img_addPicture = (ImageView) line_addImg.findViewById(R.id.img_addPicture);
        img_addPicture.setOnClickListener(this);
        img_takePicture = (ImageView) line_addImg.findViewById(R.id.img_takePicture);
        ...
        switch (v.getId()) {
            case R.id.tv_ok:
                if ("修改".equals(tv_ok.getText())) {
                    ...
                    Toast.makeText(context, "信息已打印,请到控制台查看", Toast.LENGTH_LONG).show();
                }
                break;
            case R.id.tv_back:
                finish();
