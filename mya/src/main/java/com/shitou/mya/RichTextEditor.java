...
//		<span style="font-family:SimHei;font-size:18px;">
		...
		allLayout.addView(firstEdit, firstEditParam);//添加默认的EditText
	...
	private EditText createEditText(String hint, int paddingTop) {
		EditText editText = (EditText) inflater.inflate(R.layout.richtextedit_textview, null);
	...
	private RelativeLayout createImageLayout() {
		RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.richtextedit_imageview, null);
